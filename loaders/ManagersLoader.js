...
const Class = require("../managers/entities/classroom/Class.manager.js");
...
const School = require('../managers/entities/school/School.manager.js');
...
module.exports = class ManagersLoader {
    ...
    load() {
        ...
        this.managers.user = new User({
          ...
          this.managers.student = new Student({
            ...this.injectable,
            mongomodels: this.mongomodels,
            repositories: this.repositories,
          });
